...
export function initVillages(scene, portals, opts = {}) {
  ...
  function nameForKey(key) {
    const A = ["Oak","Storm","Dawn","Iron","Sky","Elder","Moon","Sun","Frost","Ash","Raven","Wolf","Dragon","Silver","Gold","Star","High","Low","West","East","North","South","Bright","Shadow","Mist","Cloud","Thunder","Wind","Stone","River","Glen","Vale","Hill","Briar","Moss","Ice","Dust","Lumen","Myth"];
  ...
  // Persistence keys
  const STORAGE_VILLAGES = "gom.dynamic.villages.v1";
  const STORAGE_ROADS = "gom.dynamic.roads.v1";
  const STORAGE_ROADS_GEOM = "gom.dynamic.roads_geom.v1";
